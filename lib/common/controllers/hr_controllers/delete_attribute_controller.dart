...
class DeleteAttributeController extends GetxController {
  Future deleteAttribute(int attributeId) async {
    http.Response response = await http.put(
      Uri.parse('${ApiService.baseUrl}/api/attribute/deleteAttribute'),
      headers: {
