...
import 'package:timesheet/common/screens/hr_screens/hr_create_attribute.dart';
...
class HRMyAttributes extends StatefulWidget {
  const HRMyAttributes({super.key, required this.title});
  final String title;

  @override
  State<HRMyAttributes> createState() => _HRMyAttributesState();
}

final HRAttributesController hac = HRAttributesController();

class _HRMyAttributesState extends State<HRMyAttributes> {
  @override
